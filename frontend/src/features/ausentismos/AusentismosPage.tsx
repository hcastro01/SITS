...
export function AusentismosPage() {
  ...
  return <section className="module-operational-page ausentismos-page">
    <header className="module-page-hero"><div><p className="eyebrow">Trabajo Social · Departamento Médico</p><h2>Ausentismos</h2><p>Importe y confirme lotes XLSX mediante el flujo validado del sistema.</p></div></header>
    <div className="tabs module-tabs" role="tablist" aria-label="Secciones de Ausentismos">
