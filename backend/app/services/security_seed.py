...
MODULES = (
    ...
    "ACTIVIDADES", "RIESGOS_TRABAJO", "AUSENTISMO", "ACCIDENTES", "BENEFICIOS", "PRESTAMOS", "SEGUROS",
)
...
OPERATIONAL = {"ATENCIONES", "CASOS", "NOVEDADES", "RECORRIDOS", "SEGUIMIENTOS", "DERIVACIONES", "COMPROMISOS", "RIESGOS_TRABAJO"}
